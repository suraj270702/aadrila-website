...
const Blogs: React.FC = () => {
  ...
  const blogData: Blog[] = [
    {
      ...
      date: "24 July, 2023",
      description:
        "Lorem ipsum dolor sit amet, consectetur adipisicing elit. Sit harum vel consectetur, eligendi dolore ducimus repudiandae temporibus dolores facere.",
    },
    {
      title: "The Future of Cloud Computing in Business Operations",
      date: "15 August, 2023",
      description:
        "Discover how cloud computing is transforming the way businesses operate, enabling scalability, flexibility, and cost-effectiveness.",
    },
    {
      title: "Cybersecurity Best Practices for Remote Teams",
      date: "05 September, 2023",
      description:
        "Learn essential cybersecurity strategies to protect your organization's data and maintain secure operations in remote work.",
    },
    {
      title: "Machine Learning Applications in Healthcare",
      date: "20 September, 2023",
      description:
        "Explore the revolutionary impact of machine learning on healthcare, from diagnostic tools to personalized treatment plans.",
    },
    {
      title: "Building Scalable Microservices Architecture",
      date: "10 October, 2023",
      description:
        "A comprehensive guide to designing and implementing microservices architecture that scales with your business needs.",
    },
    {
      title: "Data Analytics: Turning Information into Insights",
      date: "25 October, 2023",
      description:
        "Understanding how modern data analytics tools can help organizations make informed decisions and gain advantages.",
    },
  ];
  ...
  return (
    <div className="">
      ...
      <div ref={sectionRef} className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 sm:py-12 md:py-16">
        <motion.h1
        ...
        >
          ...
          industry.
          <br className="hidden sm:block" /> Lorem Ipsum has been the industry's
          standard.
        </motion.p>
